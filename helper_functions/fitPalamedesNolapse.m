function [handles, params, stats] = fitPalamedesNolapse(stimLevels, nHighResponses, nTrials, plotting, returnCIs)
%{
Sashank Pisupati
...
Returns reparametrized parameter estimates for a 4-param cumulative normal fit with no lapse
rates. mu is the mean of the cumulative normal, sigma is the
standard deviation. Lapse probability is the sum of distances of
upper and lower asymptotes from 1 and 0 respectively, and lapse bias is
their difference.
